...
#define textgross 5
#define textklein 3
#define abstandgross textgross-1
#define abstandklein textklein-1
...
void setup() {
    ...
    tft.setRotation(3);
    tft.setTextSize(textgross);
    tft.fillRect(0, 0, (charwidth*textgross+abstandgross)*6, charheight*textgross, ILI9340_GREEN);
...
void loop(void) {
    ...
    /* tft.fillRect(0, charheight*textgross+2, charwidth*textklein, charheight*textklein, ILI9340_RED); */
    /* tft.println(millis()); */
